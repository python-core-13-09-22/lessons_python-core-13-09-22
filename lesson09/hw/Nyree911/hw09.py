...
lst_berries = [strawberry, ruspberry, blackberry, blueberry,
               goji, bilberry, cranberries, grape, black_currant, red_currant]
...
students = ["Mark", "Anthony", "Andrew", "Stewen", "Nicola",
            "Micky", "Jim", "David", "Angela", "Suzana", "Pamela", "Stefany"]
subjects = ["Math", "Biology", "English",
            "Ukrainian", "Geography", "Science", "Chemesry"]
...
for _ in range(randrange(0, 10)):
    lst_students.append(Student(students[randrange(0, 11)], randrange(1, 20), PaperCheatSheet(
        subjects[randrange(0, 6)], randrange(0, 50), size[randrange(0, 2)], places_of_hide[randrange(0, 4)])))
for _ in range(randrange(0, 10)):
    lst_students.append(Student(students[randrange(0, 11)], randrange(1, 20), ElectronicCheatSheet(
        subjects[randrange(0, 6)], randrange(0, 50), hubs[randrange(0, 4)])))
